...
function PowerfullConnection() {
  ...
  return (
    <section className="w-full overflow-hidden py-20 sm:py-24 lg:py-30 px-4 sm:px-8">
      <ContentBlock
          ...
          <>
            <p className="leading-[1.3]">
              ...
              <span className="text-white">
                Models with the M5 chip feature Thunderbolt 4. Models with M4 Pro
                or M4 Max feature Thunderbolt 5,
              </span>{" "}
              which offers transfer speeds of up to 120Gb/s.
              <sup className="underline text-xs">51</sup>
            </p>
            <p className="mt-4 leading-[1.3]">
              MacBook Pro also supports both Wi-Fi 6E
              <sup className="underline text-xs">52</sup> and Bluetooth 5.3.
            </p>
          </>
        }
      />
      ...
      <div
        ...
        className="flex flex-col gap-14 sm:gap-20 max-w-210 mx-auto pt-16 sm:pt-20"
      >
        <div
          ref={imgLeftRef}
          className="w-200 sm:w-450"
        >
          <img
            src={connection1}
            alt=""
        ...
        <div
          ref={imgRightRef}
          className="w-200 sm:w-450 self-end"
        >
          <img
            src={connection2}
            alt=""
      ...
      {/* Bottom Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 max-w-230 mx-auto gap-10 pt-20 sm:pt-25">
        <div className="flex flex-col">
          <hr className="border-sky-gradient" />
          <ul className="text-[20px] sm:text-[24px] lg:text-[28px] leading-[1.2] font-semibold text-[#f5f5f7] pt-6 sm:pt-7.5">
            <li>
              Thunderbolt<sup className="underline text-sm">11</sup>
            </li>
            <li>HDMI</li>
            <li>SDXC</li>
        ...
        <div className="flex flex-col">
          <hr className="border-sky-gradient" />
          <p className="text-[16px] sm:text-[18px] lg:text-[21px] leading-[1.35] font-semibold text-[#86868b] pt-6 sm:pt-7.5">
            <span className="text-white">Drive external displays.</span> Connect
            up to two high-resolution external displays with M5 and M4 Pro, or up
            to four high-resolution displays with M4 Max.
          </p>
        </div>
      </div>
    </section>
