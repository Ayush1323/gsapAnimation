...
function Intelligence() {
  ...
  return (
    <div>
      <div ref={IntelligenceRef} className="max-w-220 mx-auto py-10">
        <div
          className="text-[56px] font-semibold tracking-tighter
 leading-[1.1] text-[#f5f5f7]"
        >
        ...
        <p className="text-[21px] hover:underline text-[#2997ff] cursor-pointer mt-8">
          Learn more about Apple Intelligence {">"}
        </p>
      </div>
      <div className="pt-15 max-w-260 mx-auto">
        <img
          src={aiAppleImage}
