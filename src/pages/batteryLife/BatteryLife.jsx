  ...
  return (
    <div ref={textRef} className="py-30">
      ...
      <div className="max-w-237.5 mx-auto mb-10">
        <p className="text-[21px] font-semibold text-[#86868b] py-20 leading-[1.2]">
          MacBook Pro has the{" "}
          ...
          {batteryStats.map((item, index) => (
            <div key={index}>
              ...
              <div className="flex flex-col">
                <p className="text-[14px] text-[#f5f5f7] leading-[1.2]">
                  {item.label}
                </p>

                <p className="text-[48px] font-semibold text-sky-gradient">
                  {item.value}
                </p>
