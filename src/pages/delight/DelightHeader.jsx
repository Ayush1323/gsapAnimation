...
function DelightHeader() {
  return (
    <div className="py-0 sm:py-16 md:py-20 lg:py-24 xl:py-30 max-md:px-4">
      <ContentBlock
        className="mb-8 sm:mb-10 md:mb-12 lg:mb-14"
        eyebrow="Display"
        title={
          <>
            Let there <br /> be delight.
          </>
        }
      />
      <Delight />
      <p className="text-base sm:text-lg md:text-[19px] lg:text-[21px] font-semibold text-[#86868b] leading-[1.2] sm:leading-[1.24] md:leading-[1.28] lg:leading-[1.2] max-w-full sm:max-w-[600px] md:max-w-[720px] lg:max-w-[840px] xl:max-w-210 mx-auto md:px-4 sm:px-6 md:px-0">
