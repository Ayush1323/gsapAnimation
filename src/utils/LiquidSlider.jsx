export const LIQUID_SLIDER = [
    ...
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
          ...
          stunning new design makes the display feel even larger and unlocks
          more ways to personalise your experience. Take your icons from light
          to dark, or choose an alluring clear look.
        </p>
      </>
    ),
  },
  ...
  {
    image: "./src/assets/Images/liquidslider/lq-four.jpg",
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
          <span className="text-white"> Run shortcuts automagically.</span>
          Boost your productivity by automatically running shortcuts at a
          certain time of day or when you take specific actions — like
          organising images based on their content.
        </p>
      </>
    ),
  },
...
export const NANO_TEXTURE = [
  {
    image:
      "./src/assets/Images/nanoTexture/display_nano_texture__gq6yjr1q2x26_large.jpg",
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
          <span className="text-white">
          ...
          For those who work in particularly bright spaces — whether inside or
          out — the nano-texture option reduces reflections to eliminate
          distractions while maintaining an excellent viewing experience.
        </p>
      </>
    ),
  },
  {
    image:
      "./src/assets/Images/nanoTexture/display_edr__fqoq4jhrvvyq_large.jpg",
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
          <span className="text-white">
          ...
          MacBook Pro can maintain extreme brightness for HDR content,
          delivering outstanding contrast between the brightest brights and the
          blackest blacks.
        </p>
      </>
    ),
  ...
  {
    image:
      "./src/assets/Images/nanoTexture/display_promotion__c6mui8cg7tkm_large.jpg",
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
  ...
  {
    image:
      "./src/assets/Images/nanoTexture/display_multiple__cdia69mhqe82_large.jpg",
    content: (
      <>
        <p className="text-[17px] text-[#86868b] leading-[1.2] font-semibold">
          <span className="text-white">
